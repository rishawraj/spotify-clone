...
function Footer() {
  return (
    <div className="bg-black flex justify-center w-full">
      <div className="bg-black text-white  pt-12 p-4 flex flex-col gap-4 md:p-8 md:max-w-3xl">
        ...
        <div className="text-[10px] cursor-pointer flex justify-between items-start ">
